...
class TopRated extends Component {
  state = {apiStatus: apiStatusConstants.initial, topRatedList: []}
  ...
  renderFailureView = () => (
    <div>
      ...
      <button type="button" onClick={this.getTopRated}>
        Try Again
      </button>
    </div>
  )
  ...
  render() {
    const {apiStatus, topRatedList} = this.state
    switch (apiStatus) {
      case apiStatusConstants.failure:
        return this.renderFailureView()
      case apiStatusConstants.success:
        return <ReactSlick moviesList={topRatedList} />
